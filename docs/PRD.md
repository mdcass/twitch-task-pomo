...
- The editor should assume a fixed 1920x1080 base coordinate system while allowing arbitrary output dimensions configurable by the streamer
...
- `BP-TASK-P2-01` Implement drag-and-drop composer editing on the fixed 1920x1080 coordinate system with persisted position, size, and z-index.
