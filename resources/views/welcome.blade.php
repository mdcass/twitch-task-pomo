            ...
            <div class="row align-items-center min-vh-100 g-4">
                <div class="col-12 col-lg-6">
                    ...
                    <p class="lead text-body-secondary mb-4">
                        The application shell has been migrated onto product-owned Bootstrap and Phoenix-inspired primitives so future overlay, composer, and stream-management work can build on stable UI foundations.
                    </p>

                    <div class="d-flex flex-wrap gap-3">
                        <a href="{{ route('login') }}" class="btn btn-primary btn-lg">{{ __('Log in') }}</a>
                        <a href="{{ route('register') }}" class="btn btn-phoenix-secondary btn-lg">{{ __('Create account') }}</a>
                    </div>
                </div>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="twitch-stat-card p-4 p-lg-5">
                                ...
                                <p class="text-body-secondary mb-0">The purchased theme is committed for reference under `resources/third-party/themes/phoenix-v1.24.0`, while Blade, Livewire, and Vite remain fully product-owned.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="twitch-stat-card p-4 h-100">
                                ...
                                <p class="text-body-secondary mb-0">Login, registration, password recovery, profile, teams, and API tokens now share the new Bootstrap presentation.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="twitch-stat-card p-4 h-100">
                                ...
                                <p class="text-body-secondary mb-0">Maps, charts, editors, and support chat remain reference-only until a product feature needs them.</p>
                            </div>
                        </div>
                    </div>
                </div>
