            ...
            @if ($this->can_create)
                <div class="col-md-6 col-xl-3">
                    <x-overlay-trigger
                        ...
                        data-canvas-create-card
                        id="canvas-create-offcanvas"
                        surface="offcanvas">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <div>
    ...
    <div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-body-emphasis py-5 border-y">
        <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3">
            <div class="mb-3">
                ...
                <p class="text-body-secondary mb-0">{{ __('Browse active and archived canvases for the current team.') }}</p>
            </div>
            ...
            <div class="btn-group btn-group-sm" role="group" aria-label="{{ __('Canvas filters') }}">
                @foreach (['active' => __('Active'), 'all' => __('All'), 'archived' => __('Archived')] as $value => $label)
                    ...
                    ]) data-canvas-filter="{{ $value }}" wire:click="setFilter('{{ $value }}')">
                        {{ $label }}
                    </button>
                @endforeach
            </div>
                    ...
                    <tr @if (! $canvas->trashed()) x-data
                        ...
                        <td>
                            <div class="d-flex flex-column gap-1">
                                ...
                                @if ($canvas->trashed())
                                    <span class="badge badge-phoenix badge-phoenix-warning align-self-start">{{ __('Archived') }}</span>
                                @endif
                            </div>
                        </td>
                    ...
                    <tr>
                        <td colspan="4" class="px-4 py-5">
                            <div class="text-center">
                                <div class="icon-wrapper icon-wrapper-lg bg-body-highlight rounded-circle mx-auto mb-3">
