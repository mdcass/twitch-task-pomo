            ...
            <div class="col-12 col-sm-8">
                ...
                @elseif ($status === 'idle')
                    ...
                    <div class="text-body-secondary">
                        {{ __('Start playback in Spotify and this widget will update on the next poll.') }}</div>
                @else
                ...
                @if ($source !== null)
                    <div class="mt-3 small text-body-tertiary">
                        {{ __('Source: :name', ['name' => $source['display_name']]) }}</div>
                @endif
            </div>
        </div>
    </div>
