            ...
            <div class="row g-3">
                <div class="col-md-4">
                    <div class="p-3 rounded-4 bg-body-tertiary h-100">
                        <div class="small text-uppercase fw-bold text-body-tertiary mb-2">Theme Source</div>
                        <div class="fw-semibold">Phoenix v1.24.0</div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="p-3 rounded-4 bg-body-tertiary h-100">
                        <div class="small text-uppercase fw-bold text-body-tertiary mb-2">Runtime Stack</div>
                        <div class="fw-semibold">Blade, Livewire, Vite</div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="p-3 rounded-4 bg-body-tertiary h-100">
                        <div class="small text-uppercase fw-bold text-body-tertiary mb-2">Current Focus</div>
                        <div class="fw-semibold">Phase 1 dashboard shell</div>
                    </div>
                </div>
            </div>
        </div>
