...
class QuickCreateWidgetForm extends Component
{
    ...
    public function submit(QuickCreateWidget $quickCreateWidget): void
    {
        ...
        $widget = $quickCreateWidget->create(
            auth()->user(),
            $canvas,
    ...
    {
        return view('livewire.canvases.quick-create-widget-form', [
